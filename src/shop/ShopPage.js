        ...
        <Content>
                <Row align="top">
                    <Col span={12} offset={2}>
                        ...
                        <Title>Shop Men's</Title>
                        <Paragraph> Not only is clothing production harmful to our planet, but the process also kills thousands of farmers and producers each year due to chemicals and waste.</Paragraph>
                        </div>
                        <Layout>
            <Sider theme={'light'}>
              <List
